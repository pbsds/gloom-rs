...
fn main() {
    ...
    let render_thread = thread::spawn(move || {
        ...
        let _simple_shader: shader::Shader = unsafe {
            ...
            shader.activate();
            // shader.rotate(std::f32::consts::PI / 4.0, util::Direction::Z);
            shader
        };
        ...
        loop {
            ...
            unsafe {
                ...
                // _simple_shader.rotate(pi / 4.0 * tick, util::Direction::Z); enable for rotation
                gl::DrawElements(
                    gl::TRIANGLES,
                    indices.len() as i32,
                    gl::UNSIGNED_INT,
